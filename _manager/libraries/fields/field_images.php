...
class field_images {
    ...
    public function on_form($field, $default = '', $has_tip = TRUE) {
        echo '<textarea name="' . $field['name'] . '" id="' . $field['name'] . '" >' . $default . '</textarea><script type="text/javascript">CKEDITOR.replace( "' . $field['name'] . '", {toolbar:[["SImage","Maximize"]],height:400} );</script>';
