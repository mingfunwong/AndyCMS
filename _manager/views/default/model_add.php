    ...
    <?php echo form_open('model/add', array("class" => 'form-horizontal')); ?>
        ...
        <div class="card-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <?php $this->form->show('import','checkbox','允许导入');?>
                        <?php $this->form->show('export','checkbox','允许导出'); ?>
                        <?php $this->form->show('single','checkbox','显示单页'); ?>
                        <?php $this->form->show('level','checkbox','模型层级'); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <select type="text" id="icon" name="icon">
                        <option selected value="fa-th-list" data-data='{"name":"fa-th-list","icon":"fa-th-list"}'>fa-th-list</option>
                    </select>
                </div>
                <div class="col-sm-6">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <?php $this->form->show('order','input','',10); ?>
                    </div>
                </div>
                <div class="col-sm-6">
