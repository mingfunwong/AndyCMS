                ...
                <div class="col-sm-4">
                    <div class="form-group">
						<?php foreach($rights as $key=>$v): ?>
							<div class="checkbox"><label><input name="right[]" type="checkbox" value="<?php echo $key; ?>" checked="checked" /><?php echo $v; ?></label></div>
						<?php endforeach; ?>
						<hr>
						<?php foreach($models as $key=>$v): ?>
							<div class="checkbox"><label><input name="model[]" type="checkbox" value="<?php echo $key; ?>" checked="checked" /><?php echo $v; ?></label></div>
						<?php endforeach; ?>
                    </div>
                </div>
            </div>
