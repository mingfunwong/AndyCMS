! function (t) {
    ...
    t.expr[":"].notmdproc = function (o) {
        ...
        options: {
            ...
            arrive: !0,
            autofill: !1,
            withRipples: [".sidebar .nav li a", ".btn:not(.btn-link)", ".card-image", ".navbar a:not(.withoutripple)", ".footer a:not(.withoutripple)", ".dropdown-menu a", ".nav-tabs a:not(.withoutripple)", ".withripple", ".pagination li:not(.active):not(.disabled) a:not(.withoutripple)"].join(","),
        ...
        checkbox: function (o) {
            ...
            i.on("change", function (){$(this).attr("animate", 1);})
            n(i)
        },
